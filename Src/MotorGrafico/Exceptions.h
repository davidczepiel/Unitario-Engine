...
/// <summary>
/// Exception generated by some operations regarding sceneNodes
/// </summary>
DECLARE_EXCEPTION(SceneNodeException);
...
/// <summary>
/// Exception generated by some initialization error.
/// </summary>
/// <param name=""></param>
DECLARE_EXCEPTION(GraphicsEngineInit);
