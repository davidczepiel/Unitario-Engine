...
/// <summary>
/// Exception generated by some operations of PhysxEngine
/// </summary>
DECLARE_EXCEPTION(EPhysxEngine);

/// <summary>
/// Exception generated by some operations of RayCasts
/// </summary>
DECLARE_EXCEPTION(ERayCast);
