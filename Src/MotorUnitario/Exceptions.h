...
/// <summary>
/// Exception generated by trying to find a component name that does not match any actual component in the Lua file
/// </summary>
DECLARE_EXCEPTION(LuaComponentNotFoundException);
/// <summary>
/// Exception generated by trying to create a component with wrong initialization
/// </summary>
DECLARE_EXCEPTION(LuaComponentException);
/// Exception generated by operations regarding managing animator component
/// </summary>
DECLARE_EXCEPTION(AnimatorException);
/// Exception generated when a path is wrong
/// </summary>
DECLARE_EXCEPTION(SourcePathException);
