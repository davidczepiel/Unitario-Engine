	...
	)
{
	...
	SGX_Light_Directional_DiffuseSpecular(lTexcoord_2, iTexcoord_1, iTexcoord_2.xyz, derived_light_diffuse_colour.xyz, derived_light_specular_colour.xyz, surface_shininess, oColor_0.xyz, lColor_1.xyz);
