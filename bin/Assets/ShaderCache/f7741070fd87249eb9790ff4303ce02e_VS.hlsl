...
void main
	(
	 ...
	 out float3	oTexcoord_3 : TEXCOORD3
	)
{
	float4	lColor_0;
	float4	lColor_1;
	...
	lNormalMapTempDir	=	light_position1.xyz-lTexcoord_4;

	FFP_Transform(inv_world_rotation_matrix1, lNormalMapTempDir, lNormalMapTempDir);

	FFP_Transform(lMatTBN, lNormalMapTempDir, oTexcoord_3);
}
