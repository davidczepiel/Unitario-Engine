...
void main
	(
	 ...
	 in float3	iTexcoord_3 : TEXCOORD3, 
	...
	)
{
	...
	SGX_FetchNormal(gNormalMapSampler1, iTexcoord_0, lTexcoord_2);
	...
	SGX_Light_Point_DiffuseSpecular(lTexcoord_2, iTexcoord_1, iTexcoord_3, light_attenuation1, derived_light_diffuse_colour1.xyz, derived_light_specular_colour1.xyz, surface_shininess, oColor_0.xyz, lColor_1.xyz);
