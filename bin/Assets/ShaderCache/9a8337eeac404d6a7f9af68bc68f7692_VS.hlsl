	...
	)
{
	...
	TempVal3x4	=	world_scale_shear_matrix_array_3x4[int(iBlendIndices_0.z)];

	TempVal3x4	=	iBlendWeights_0.z*TempVal3x4;

	blendS	=	TempVal3x4+blendS;

	TempVal3x4	=	world_scale_shear_matrix_array_3x4[int(iBlendIndices_0.w)];

	TempVal3x4	=	iBlendWeights_0.w*TempVal3x4;
	...
	lColor_12	=	vec4(0.000000,0.000000,0.000000,0.000000);
}
