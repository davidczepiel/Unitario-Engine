	...
	)
{
	...
	FFP_Transform(world_matrix_array_3x4[int(iBlendIndices_0.z)], iPos_0, TempVal4.xyz);

	TempVal4.w	=	1.00000;

	TempVal4	=	TempVal4*iBlendWeights_0.z;

	lTexcoord_0	=	TempVal4+lTexcoord_0;

	FFP_Transform(world_matrix_array_3x4[int(iBlendIndices_0.w)], iPos_0, TempVal4.xyz);

	TempVal4.w	=	1.00000;

	TempVal4	=	TempVal4*iBlendWeights_0.w;
	...
	FFP_Transform(world_matrix_array_3x4[int(iBlendIndices_0.z)], iNormal_0, TempVal3);

	TempVal3	=	TempVal3*iBlendWeights_0.z;

	lTexcoord_1	=	TempVal3+lTexcoord_1;

	FFP_Transform(world_matrix_array_3x4[int(iBlendIndices_0.w)], iNormal_0, TempVal3);

	TempVal3	=	TempVal3*iBlendWeights_0.w;
